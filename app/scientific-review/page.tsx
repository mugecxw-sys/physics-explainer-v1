...
export const metadata = pageMetadata("Scientific Review", "How Physics, Plainly. represents scientific review without overstating expert involvement.", "/scientific-review/");
